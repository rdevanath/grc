...
!!! tip
    The 5 Trust Services criteria are - security, availability, processing integrity, confidentiality, privacy. Security controls testing is mandatory, while the rest (availability, processing integrity, confidentiality, and privacy) are optional.
...
- They assess whether the service organization’s controls meet the Trust Services Criteria.
They issue the final SOC 2 report, which includes their opinion on the design and/or operating effectiveness of control.
...
There are two ways sub-service orgs are handled in SOC 2:
- Inclusive Method: Their controls are included and tested in the SOC 2 report.
- Carve-Out Method: Their controls are excluded, but the service org must describe what’s outsourced and what risks are involved.
